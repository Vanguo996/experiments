...
class UnaryStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetServiceResponse = channel.unary_unary(
                '/Unary/GetServiceResponse',
...
class UnaryServicer(object):
    ...
    def GetServiceResponse(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_UnaryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetServiceResponse': grpc.unary_unary_rpc_method_handler(
                    servicer.GetServiceResponse,
...
class Unary(object):
    ...
    def GetServiceResponse(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Unary/GetServiceResponse',
